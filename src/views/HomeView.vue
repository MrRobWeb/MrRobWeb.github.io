<template>
    <div class="">
        ...
        <h1 class="mt-8 mb-4 text-center text-3xl sm:text-4xl uppercase font-bold dark:text-white animate-fade">Robert Weber</h1>
        ...
        <h1 class="mb-2 text-center font-mono lg:text-4xl dark:text-white text-2xl animate-fade">
            ...
            <span v-show="isTypeWrite == 1" class="relative font-bold">
                ...
                <span
                class="{`${styles.cursor} text-left absolute -bottom-0 left-0 -top-1 inline-block bg-[#ffffff]  dark:bg-[#0F172A] duration-500 transition-all ease-in-out w-full animate-type will-change`}"
                >|</span>
            </span>
