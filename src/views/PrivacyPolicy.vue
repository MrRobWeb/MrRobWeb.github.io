<template>
    <div class="flex flex-col  sm:w-8/12 mx-auto animate-fade dark:text-gray-100 ">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or
                    &quot;Our&quot; in this Agreement) refers to mrrobweb.github.io.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to mrrobweb.github.io, accessible from <a href="mrrobweb.github.io"
                        rel="external nofollow noopener" target="_blank">mrrobweb.github.io</a></p>
            </li>
            <li>
